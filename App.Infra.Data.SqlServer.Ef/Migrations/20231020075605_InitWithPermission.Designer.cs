...
namespace App.Infra.Data.SqlServer.Ef.Migrations
{
    ...
    [Migration("20231020075605_InitWithPermission")]
    partial class InitWithPermission
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("App.Domain.Core.Users.Entities.UserPermission", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<bool>("PermissionMode")
                        .HasColumnType("bit");
            ...
            modelBuilder.Entity("App.Domain.Core.Users.Entities.UserPermission", b =>
                {
                    b.HasOne("App.Domain.Core.Users.Entities.Permission", "Permission")
                        .WithMany("UserPermissions")
                        .HasForeignKey("PermissionId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("App.Domain.Core.Users.Entities.ApplicationUser", "User")
                        .WithMany()
